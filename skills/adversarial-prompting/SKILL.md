...
description: Use when facing complex problems (technical or non-technical) that need thorough analysis, multiple solution approaches, and validation of proposed fixes before implementation. Generates several solutions, rigorously critiques each for failure modes, develops and validates fixes, and consolidates into ranked recommendations.
version: 1.0.0
author: Abe Diaz (@abe238)
license: MIT
metadata:
  hermes:
    tags: [reasoning, problem-solving, critique, decision-analysis, red-team, validation]
    related_skills: [prompt-optimizer, rapid-domain-mastery]
---
